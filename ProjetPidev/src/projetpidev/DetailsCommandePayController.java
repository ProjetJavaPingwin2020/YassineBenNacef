...
public class DetailsCommandePayController implements Initializable {
    ...
    /////////////////////////////////////////////////
      private static String FILE = "C:\\Users\\Yassiine\\Desktop\\Pidev Java\\Bon de commande.pdf";
        ...
        last_change=LocalDateTime.now();
         ...
         jour=last_change.getDayOfMonth();
            ...
            try {
               ...
               s2.ajouter_revenu();
              int login= Integer.parseInt(s1.getlogin()) ;
              String tel= s1.gettelephone(login);
