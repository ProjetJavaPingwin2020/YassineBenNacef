...
import static projetpidev.FXMLFrontProduitController.pE_id_selection;
    ...
    public void afficher_champs()
     {
       ...
       image = new Image("file:"+FXMLFrontProduitController.pE_nomimage_selection+"", imageView.getFitWidth(), imageView.getFitHeight(), true, true);
